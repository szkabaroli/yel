...
use crate::lir::{
    LirResource, LirEffect, LirExpr, LirExprKind, LirHandler, LirNode, LirNodeKind, LirSignal,
};
...
pub fn generate_rust(component: &LirResource, ctx: &CompilerContext) -> String {
...
impl<'ctx> RustCodegen<'ctx> {
    ...
    fn generate_component(&mut self, component: &LirResource) -> String {
    ...
    fn generate_render_method(&mut self, component: &LirResource) {
